...
const Header = () => {
    ...
    return (
        <div className="hero">
            ...
            {/* --------hamburger menu------------ */}
            <div
                className={`hidden menu justify-center bg-[#00000080] absolute inset-0 z-[10] overflow-hidden  ${openMenu ? "open" : ""
                    }`}
            >
            ...
            >
                <div className="relative z-[10]">
                    ...
                    <div className="flex flex-col md:flex-row md:justify-center items-center   gap-[1rem] mt-[3rem] lg:mt-[0]">
                        <a href="#chain" className="text-[white] rounded-[8px] w-[176px] h-[55px] capitalize z-[10] flex justify-center items-center btn hero-blue text-[17px]">
                            get started
                        </a>
                        <a href="#swap" className="text-[black] rounded-[8px] w-[176px] h-[55px] capitalize btn2 z-[10] flex justify-center items-center text-[17px]">
                            dex Aggregator
                        </a>
                    </div>
