      ...
      <ScrollAnimation animateIn="animate-slideRight" offset={offset}>
        ...
        <section className="flex  flex-row  gap-[2rem]  items-center justify-between">
          ...
          <div className="flex flex-col gap items-center  md:mt-[0]">
            <img
              src="https://res.cloudinary.com/dn25ccoss/image/upload/v1677877973/coinofficial_opor4h.svg"
              alt="rango"
            />
          ...
          <div className="flex flex-col gap items-center">
            <img
              src="https://res.cloudinary.com/dn25ccoss/image/upload/v1677877988/rango_am8tih.svg"
              alt="rango"
            />
            <p className="text-[white]  lg:leading-[40px] pt-[1rem] lg:text-[25px] font-[600]  text-center capitalize">
              rango exchange
            </p>
          </div>
          {/* ----patner 3---- */}
          <div className="flex flex-col gap  items-center">
            <img
              src="https://res.cloudinary.com/dn25ccoss/image/upload/v1677878005/zah_fxjbsd.svg"
              alt="rango"
            />
          ...
          <div className="flex flex-col gap items-center">
            <img
              src="https://res.cloudinary.com/dn25ccoss/image/upload/v1677877982/interfi_zojlzv.svg"
              alt="rango"
            />
