          ...
          >
            ...
            <SwiperSlide className="px-[4rem] w-[200px] ">
              ...
              <p className="text-white font-[300] text-[18px] lg:text-[26.96px]">
                ...
                Operations, Liquidity Pools, Staking set by Smart Contract and
                can be changed dynamically overtime as the project develops
              </p>
            </SwiperSlide>
            {/* ------slide 2--- */}
            <SwiperSlide className="px-[4rem] w-[200px]">
              ...
              <p className="text-white font-[300] text-[18px] lg:text-[26.96px]">
                ...
                operations and marketing. The exact rate is dynamic and is set
                by Smart Contract, and can be adjusted at any time.
              </p>
            </SwiperSlide>
            {/* ------slide 3--- */}
            <SwiperSlide className="px-[4rem] w-[200px]">
            ...
            <SwiperSlide className="px-[4rem] w-[200px]">
              ...
              <p className="text-white font-[300] text-[18px] lg:text-[26.96px]">
                Parts of the funds received from the Buy/Sell transfer taxes
                will go towards $GODZ token burns, creating a deflationary and
                scarce $GODZ token. The exact rate is dynamic and is set by
